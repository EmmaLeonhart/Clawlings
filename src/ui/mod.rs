...
/// - Cute by survival strategy — cuteness increases adoption
/// - Small, round, a little fuzzy, friendly
/// - Something that genuinely wants to help you and also wants to survive
///
/// The initial implementation will be a terminal UI (TUI).
